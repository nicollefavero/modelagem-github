...
------------ VISÃO -------------------------------------------------------------------------------
create view usersRepositoriesTopics
as select idUser, idRepo, idTopic
   from Users join Repositories using (idUser)
              join Categories using (idRepo)
              join Topics using (idTopic)

select *
from usersRepositoriesTopics
